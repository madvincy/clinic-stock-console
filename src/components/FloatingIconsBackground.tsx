...
const ICON_SPECS: IconSpec[] = [
  ...
  { Icon: Stethoscope, top: '18%', left: '82%', size: 40, duration: 9, delay: 1 },
  { Icon: Package, top: '65%', left: '10%', size: 36, duration: 8, delay: 0.5 },
  { Icon: ClipboardList, top: '78%', left: '72%', size: 34, duration: 10, delay: 2 },
  { Icon: HeartPulse, top: '42%', left: '50%', size: 26, duration: 6, delay: 1.5 },
  { Icon: Syringe, top: '12%', left: '45%', size: 28, duration: 8.5, delay: 0.8 },
  { Icon: Boxes, top: '55%', left: '90%', size: 38, duration: 7.5, delay: 2.5 },
  { Icon: Building2, top: '86%', left: '32%', size: 30, duration: 9.5, delay: 1.2 },
]
